...
@<b>{AWS公式ドキュメント}@<br>{}
@<href>{https://docs.aws.amazon.com/ja_jp/cognito/latest/developerguide/cognito-user-identity-pools.html, Amazon Cognito ユーザープール}@<br>{}
UserPoolの開発者向けドキュメントです。@<br>{}

@<href>{https://docs.aws.amazon.com/ja_jp/cognito/latest/developerguide/cognito-identity.html, Amazon Cognito ID プール (フェデレーティッドアイデンティティ)}@<br>{}
Federated Identityの開発者向けドキュメントです。@<br>{}
