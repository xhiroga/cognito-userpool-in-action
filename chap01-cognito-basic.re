...
Cognito Identity Providerと呼ばれることもあります。@<fn>{DC0092D6-2FE6-4F34-967F-EABA1E637EFE}以下の機能を備えています。
...
一応、既存のユーザー認証基盤をUserPoolと連携させることで、UserPoolを認可サーバーとして利用できます。  
このケースではサードパーティの認可サービスを検討するのも手です。@<fn>{35f80250}  
@<br>{}
@<br>{}
